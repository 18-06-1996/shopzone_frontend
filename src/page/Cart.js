...
const Cart = () => {
  ...
  const totalOty = productCartItem.reduce((acc, curr) => acc + parseInt(curr.qty), 0)
  return (
    <>
          ...
          productCartItem[0] ?
            <div className=' my-4 flex gap-3'>
              ...
              <div className=' w-full max-w-sm  ml-auto'>
                ...
                <button className='bg-red-500 w-full font-bold text-lg py-2 text-white'>Payment</button>
              </div>
            </div>
